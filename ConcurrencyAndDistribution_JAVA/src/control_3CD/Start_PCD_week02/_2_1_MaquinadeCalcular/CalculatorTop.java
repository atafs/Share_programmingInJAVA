package control_3CD.Start_PCD_week02
._2_1_MaquinadeCalcular;
...
public class CalculatorTop extends JFrame implements ActionListener, KeyListener{
    ...
    public CalculatorTop(String title){
        super(title);
        setLayout(layout);
    ...
    public static void main(String[] args) {
    	CalculatorTop window = new CalculatorTop("Basic Calculator");
